...
public class Tamagoshi extends Observable{
    ...
    public int getHungry() { return m_hungry; }

    public int getHappyness() { return m_happyness; }
    ...
    public void GiveAffection() {
        ...
        String s = "";
        switch(nb) {
            case 2: s = "Il lève la pâte pour vous remerciez !"; break;
            case 3: s = "Il ronronne !"; break;
            case 4: s = "Il sourit !"; break;
            case 5: s = "Il a une pokerface"; break;
        }
    ...
    public void setName(String s) {
        if(s.length() > 9)
        {
            setMsg("le nom de votre tamagoshi doit faire au moins 9 caractères");
        }else m_name = s;
    }
